    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                ...
                @endif
                <form method="POST" action="{{route('backend::sembako-packages.update', $data['id'])}}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <div class="form-group{!! $errors->has('items') ? ' has-error' : '' !!}">
                                                ...
                                                <select class="select-remote form-control"
                                                    ...
                                                    @foreach($sembakoItems as $sembakoItem)
                                                        <option {{in_array($sembakoItem->id, $listSelectedSembakoItem ?: []) ? "selected": ""}} value="{{$sembakoItem->id}}">{{$sembakoItem->item_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{route('backend::sebako-packages.index')}}" class="btn btn-danger">Back</a>
                    </div>
                </form>
            </div>
        </div>
