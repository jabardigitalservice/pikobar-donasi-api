...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs primary">
        <li class="active">
            @if($model->id == config("covid19.DEFAULT_SIDEBAR_ID"))
                <a href="#details" data-toggle="tab">Root Menu</a>
            @else
                <a href="#details" data-toggle="tab">Menu [{{$model->menu_title}}]</a>
            @endif
        </li>
        <div class="box-tools pull-right">
            <button type="button" id="btnAddSubmenu" class="btn btn-success btn-sm" data-action="NEW"
    ...
    <form accept-charset="utf-8" class="form-vertical" id="form-menu" method="POST"
        ...
        @csrf
        <input type="hidden" name="is_root" value="true"/>
